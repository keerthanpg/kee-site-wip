var data = [
	{	
		...
		{	
            ...
            'description' : 'This is a geospatial visualization of IIT Kharagpur students across gender, departments, categories etc. It was an effort to understand where people in KGP are from, and how that changes over the years. Interestingly, the demographics do not change much.<br><br> <code>#python #d3.js #javascript #html #css </code>',
		...
		{	
            ...
            'description' : "Inspired by the anonymous street artist Banksy, 'Another Brick In The Wall' was my second wall-painting project in exploration of the medium. The paintings were done on walls in my room in Bangalore. The collection contains Pacman, a peacock, birds, cats on the moon and Banky's famous girl flying with the aid of some balloons. <code>#Banksy #Acrylic-colours </code>",
            ...
            'description' : 'Heavily inspired by Banksy, this was an attempt to fill my neighbourhood with balloons. <code>#Banksy #spray-paints #stencils</code>',
		...
		{	
            ...
            'description' : 'This is a wishlist, by the students studying at Disha Seema. Disha Seema is a residential school at IIT Kharagpur hosting 300+ students from underprivileged backgrounds in rural West Bengal, Jharkhand and Orissa. It was established in 1992 by Hansa Nundi, a 1964 alumnus of IIT Kharagpur and the first woman to graduate from the Electrical Engineering Department. The school has a library, an aquaguard, a television, a park made of tires among other facilities. The school is supported by donations from alumni and well-wishers but with the burgeoning number of students, they are always short of money, to the extent that most kids have never had milk or eggs.<code>#html #css #javascript </code>' ,
            ...
            'description' : "This was an effort to visualize and measure the attendance of Members of Parliament, aggregating them by elected state and political parties<br><br> <code>#python #d3.js #javascript #html #css </code>",
